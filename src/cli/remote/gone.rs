...
use crate::{db::postgres::connect_pg, entities::{instance, prelude::*}};
...
pub async fn gone(config_path: &str, url: &str) -> Result<(), Box<dyn std::error::Error>> {
    ...
    host.suspension_state = Set(crate::entities::sea_orm_active_enums::InstanceSuspensionstateEnum::GoneSuspended);
