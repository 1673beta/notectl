...
pub struct Model {
  ...
  #[sea_orm(column_name = "ugcVisibilityForVisitor")]
  pub ugc_visibility_for_visitor: String,
  #[sea_orm(column_name = "singleUserMode")]
  pub single_user_mode: bool,
  #[sea_orm(column_name = "proxyRemoteFiles")]
  pub proxy_remote_files: bool,
  #[sea_orm(column_name = "signToActivityPubGet")]
  pub sign_to_activity_pub_get: bool,
  #[sea_orm(column_name = "allowExternalApRedirect")]
  pub allow_external_ap_redirect: bool,
  #[sea_orm(column_name = "urlPreviewAllowRedirect")]
  pub url_preview_allow_redirect: bool,
}
